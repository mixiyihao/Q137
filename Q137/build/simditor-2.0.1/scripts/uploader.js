    ...
    return file.xhr = $.ajax({
      ...
      success: (function(_this) {
        return function(result) {
          // var newresult = JSON.parse("{\"file_path\":\"http://10.103.241.3:8080/lls-web/"+ result.file_path +"\"}");
            var url = 'http://' + window.location.href.split('/')[2] + '/lls-web/';
            var newpath = result.file_path;
            var newresult = JSON.parse("{\"file_path\":\"" + url + newpath +"\"}");
