...
import MainBody from '../../../assistantSup/components/teacherAnalyze/stagePaper/stagePaperBody.jsx';
...
export default class teacherStagePaperLibrary extends Component {
    constructor() {
        super();
        this.state = {
            majors: [],
