...
import SchoolSwitching from '../../../assistantSup/public/schoolSwitching/schoolSwitching.jsx';
export default class teacherfinallist extends React.Component {
    ...
    handleTypeTabpigai(e) {
        ...
        if (e.target.title != this.state.Spropigainame) {
            ...
            this.Sprofinallistajax(this.state.majorid, this.state.courseid,
                e.target.getAttribute("data-key"), this.state.examname, 1, this.state.schoolID);
        } else {
            this.setState({
                UlClickStatepigai: false
            })
    ...
    showNext() {
        if (this.state.pages == this.state.page) {
            ...
            this.Sprofinallistajax(this.state.majorid, this.state.courseid, this.state.type, this.setState.examname, this.state.page, this.state.schoolID);
