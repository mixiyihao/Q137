...
import styles from './styleCreactTestSubject.js';
...
export default class CreactTestSubject extends React.Component {
    ...
    //     this.setState({
    //         textareaLength: nextProps.stem.length
    //     });
    // }
    ...
    onSelectedState(index) {
        ...
        if (this.props.selectValue != 3) {
            ...
            document.getElementById("creactTestSubjectRadioInputB" + index).checked = false; // 选项B选中的状态
            document.getElementById("creactTestSubjectRadioInputC" + index).checked = false; // 选项C选中的状态
            document.getElementById("creactTestSubjectRadioInputD" + index).checked = false; // 选项D选中的状态
        }
        if (this.props.selectValue == 2) {
            document.getElementById("creactTestSubjectRadioInputE" + index).checked = false; // 选项E选中的样式
            document.getElementById("creactTestSubjectRadioInputF" + index).checked = false; // 选项F选中的样式
    ...
    onSubjectValue(key) {
        ...
        if (this.props.selectValue == 2) {
            this.props.onSubjectValue({ key: key, value: { selectValue: selectValue, stem: textareaValue, inputValueA: inputValueA, inputValueB: inputValueB, inputValueC: inputValueC, inputValueD: inputValueD, inputValueE: inputValueE, inputValueF: inputValueF, optionAState: optionAState, optionBState: optionBState, optionCState: optionCState, optionDState: optionDState, optionEState: optionEState, optionFState: optionFState, optionAStyle: optionAStyle, optionBStyle: optionBStyle, optionCStyle: optionCStyle, optionDStyle: optionDStyle, optionEStyle: optionEStyle, optionFStyle: optionFStyle, optionState1: optionState1, optionState2: optionState2, optionState3: optionState3 } });
        } else if (this.props.selectValue == 1 || this.props.selectValue == '')  {
            this.props.onSubjectValue({ key: key, value: { selectValue: selectValue, stem: textareaValue, inputValueA: inputValueA, inputValueB: inputValueB, inputValueC: inputValueC, inputValueD: inputValueD, optionAState: optionAState, optionBState: optionBState, optionCState: optionCState, optionDState: optionDState, optionAStyle: optionAStyle, optionBStyle: optionBStyle, optionCStyle: optionCStyle, optionDStyle: optionDStyle, optionState1: optionState1, optionState2: optionState2, optionState3: optionState3 } });
        } else if (this.props.selectValue == 3) {
    ...
    render() {
        ...
        let arr1 = <div style={styles.creactTestSubjectRadio}>
            <p style={styles.creactTestSubjectRadioP}>
                ...
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextA" + props.index} style={props.optionAStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" defaultValue={props.optionA} id={"creactTestSubjectRadioTextA" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextB" + props.index} style={props.optionBStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" defaultValue={props.optionB} id={"creactTestSubjectRadioTextB" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextC" + props.index} style={props.optionCStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" defaultValue={props.optionC} id={"creactTestSubjectRadioTextC" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextD" + props.index} style={props.optionDStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" defaultValue={props.optionD} id={"creactTestSubjectRadioTextD" + props.index}></textarea>
            </p>
        ...
        let arr2 = <div style={styles.creactTestSubjectRadio2}>
            <p style={styles.creactTestSubjectRadioP}>
                ...
                <span style={props.optionAStyle ? styles.creactTestSubjectRadioSpanStyle : styles.creactTestSubjectRadioSpan}>A</span>
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextA" + props.index} style={props.optionAStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" name="textA" defaultValue={props.optionA} id={"creactTestSubjectRadioTextA" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <span style={props.optionBStyle ? styles.creactTestSubjectRadioSpanStyle : styles.creactTestSubjectRadioSpan}>B</span>
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextB" + props.index} style={props.optionBStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" name="textB" defaultValue={props.optionB} id={"creactTestSubjectRadioTextB" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <span style={props.optionCStyle ? styles.creactTestSubjectRadioSpanStyle : styles.creactTestSubjectRadioSpan}>C</span>
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextC" + props.index} style={props.optionCStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" name="textC" defaultValue={props.optionC} id={"creactTestSubjectRadioTextC" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <span style={props.optionDStyle ? styles.creactTestSubjectRadioSpanStyle : styles.creactTestSubjectRadioSpan}>D</span>
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextD" + props.index} style={props.optionDStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" name="textD" defaultValue={props.optionD} id={"creactTestSubjectRadioTextD" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextE" + props.index} style={props.optionEStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" name="textE" defaultValue={props.optionE} id={"creactTestSubjectRadioTextE" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectRadioP}>
                <div style={styles.inputBox}>
                ...
                <textarea className="isTextarea" ref={"creactTestSubjectRadioTextF" + props.index} style={props.optionFStyle ? styles.creactTestSubjectRadioTextStyle : styles.creactTestSubjectRadioText} type="text" name="textF" defaultValue={props.optionF} id={"creactTestSubjectRadioTextF" + props.index}></textarea>
            </p>
            <p style={styles.creactTestSubjectMessageP}>
                <span style={styles.creactTestSubjectMessageSpan}>*</span>
                选中为正确答案
