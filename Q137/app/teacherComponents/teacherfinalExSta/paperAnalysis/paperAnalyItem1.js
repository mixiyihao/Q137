  ...
  render() {
    ...
    return (
      <div className="checkboxExam">
        ...
        <p className="finalEXspre_pq"><b className="spre_previewtestItem"><i className="iii" style={styles}>0</i>{this.props.zcindex+this.props.Item+1}<i className="ii">{this.props.exLength<10?"/0"+this.props.exLength:"/"+this.props.exLength}</i></b>
        <textarea id="haha" style={stemheight} value={this.props.stem}></textarea>
        </p>
          <div className="finalExradiocheck styleblock" style={styleoptiona}><input type="radio" name="type"  id={this.props.zcindex+this.props.Item+'test1'} disabled/><label className="spre_Item Chspre_Item" htmlFor={this.props.zcindex+this.props.Item+"test1"} className={!this.state.A_style ? "Spre-checkY" : "Spre-checkX" }><span className="finalExanswerItem">A</span><b className="spro-bspreview">{this.props.option_a}</b></label></div>
          <div className="finalExradiocheck styleblock" style={styleoptionb}><input type="radio" name="type"  id={this.props.zcindex+this.props.Item+'test2'} disabled/><label className="spre_Item Chspre_Item" htmlFor={this.props.zcindex+this.props.Item+"test2"} className={!this.state.B_style ? "Spre-checkY" : "Spre-checkX" }><span className="finalExanswerItem">B</span><b className="spro-bspreview">{this.props.option_b}</b></label></div>
          <div className="finalExradiocheck styleblock" style={styleoptionc}><input type="radio" name="type"  id={this.props.zcindex+this.props.Item+'test3'} disabled/><label className="spre_Item Chspre_Item" htmlFor={this.props.zcindex+this.props.Item+"test3"} className={!this.state.C_style ? "Spre-checkY" : "Spre-checkX" }><span className="finalExanswerItem">C</span><b className="spro-bspreview">{this.props.option_c}</b></label></div>
          <div className="finalExradiocheck styleblock" style={styleoptiond}><input type="radio" name="type"  id={this.props.zcindex+this.props.Item+'test4'} disabled/><label className="spre_Item Chspre_Item" htmlFor={this.props.zcindex+this.props.Item+"test4"} className={!this.state.D_style ? "Spre-checkY" : "Spre-checkX" }><span className="finalExanswerItem">D</span><b className="spro-bspreview">{this.props.option_d}</b></label></div>
          <div className="finalExradiocheck styleblock" style={styleoptione}><input type="radio" name="type"  id={this.props.zcindex+this.props.Item+'test5'} disabled/><label className="spre_Item Chspre_Item" htmlFor={this.props.zcindex+this.props.Item+"test5"} className={!this.state.E_style ? "Spre-checkY" : "Spre-checkX" }><span className="finalExanswerItem">E</span><b className="spro-bspreview">{this.props.option_e}</b></label></div>
          <div className="finalExradiocheck styleblock" style={styleoptionf}><input type="radio" name="type"  id={this.props.zcindex+this.props.Item+'test6'} disabled/><label className="spre_Item Chspre_Item" htmlFor={this.props.zcindex+this.props.Item+"test6"} className={!this.state.F_style ? "Spre-checkY" : "Spre-checkX" }><span className="finalExanswerItem">F</span><b className="spro-bspreview">{this.props.option_f}</b></label></div>
          <div className="rightItem sprepaper_p paperAnalyradioItem "><span className="finEXanswer_span">正确答案:<i id="i">{this.props.answer}</i></span></div>
        </div>
