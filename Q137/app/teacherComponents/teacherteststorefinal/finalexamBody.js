  ...
  Finallisthtmltitle(EXflag){
    return(
       <div className="spro_thQuhead">
                        ...
                        <div className="spro_titkec">
                            课程
                        </div>
                        {/*<div className="spro_titbeiz">
                            备注
                        </div>*/}
                        <div className="spro_titcaoz">
                            操作
                        </div>
                    </div>
    )
                    ...
                    <div className="spro_selebody_final">
                        <div className="spro_thselection spro_select_finalExam">
                            <div className="sprosatPublicleftselect_final sele_fino" >专业 :
                                        <span onClick={this.ChooseStatemajor.bind(this,"major")} style={spanStylemajor}>{this.state.SproMajorname}</span>
                                            <ul style={ulStylemajor} className="SprothQuestion">
                                              <li title="全部专业" data-key="allM" data-flag="major" data-majorid="" onClick={this.handleTypeTabmajor.bind(this)}>全部专业</li>
                                               {this.limajor()}
                                            </ul>
                            </div>
                            <div className="sprosatPublicleftselect_final sele_fint">课程 :
                                        <span onClick={this.ChooseStatemajor.bind(this,"Cou")} style={spanStyleCou}>{this.state.SproCoursname}</span>
                                            <ul style={ulStyleCou} className="SprothQuestion">
                                              <li title="全部课程" data-key="allC" data-flag="Cou" data-courseid="" onClick={this.handleTypeTabmajor.bind(this)}>全部课程</li>
                                               {this.liCou()}
                                            </ul>
                            </div>
                        </div>
