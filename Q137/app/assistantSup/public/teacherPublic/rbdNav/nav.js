...
export default class RbdNavBar extends React.Component {
    ...
    componentWillMount() {
        //    console.log(typeof(sessionStorage.getItem("teacherComp")))
            ...
            <div className="rbd-header">
                <div className="rbdInner">
                    <div className="jumpToIndex">
                        <Link to={"/"}><i className={this.createTopPic()}></i></Link>
                    </div>
                    <div className="rbdContent">
                        ...
                        <span className={this.props.ActiveBuff == 3 ? "R-showBox R-active" : "R-showBox"}>课程</span>
                        <span className={this.props.ActiveBuff == 4 ? "R-showBox R-active" : "R-showBox"}>考试管理</span>
                        {sessionStorage.getItem('userJudge')=='EM'||sessionStorage.getItem('userJudge')=='PM'||sessionStorage.getItem('userJudge')=='HM'?<span className={this.props.ActiveBuff == 8 ? "R-active Initevaluate" : "Initevaluate"}><Link to="/studentAchievement">学员成绩</Link></span>:''}
                        <span className={this.props.ActiveBuff == 5 ? "R-active Initstatis" : " Initstatis"}><Link to="/">学员管理</Link></span>
                        <span className={this.props.ActiveBuff == 6 ? "R-showBox R-active" : "R-showBox"}>{sessionStorage.getItem('userJudge')=='EM'? "教管管理":sessionStorage.getItem('userJudge')=='PM'||sessionStorage.getItem('userJudge')=='HM'?'用户管理':'助教管理'}</span>
    ...
    createTopPic(){
        var mark = sessionStorage.getItem('userJudge');
        var str = ''
        switch(mark){
            case 'TM':
                str="classmaster"
