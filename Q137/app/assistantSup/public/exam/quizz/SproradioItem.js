      ...
      <div className="exItem spre_newexItem">
          <div className="radioExam">
            <div className="h-titlItem spre_newexamdiv">   
              ...
              <strong style={{display:this.props.EXLorW!="SL"?"none":"inline-block"}} className={this.state.exmaxx==this.props.answer?"iconfont icon-zhengque finalrflag":"iconfont icon-cuowu finalrflag"}></strong>
              ...
              <b className="spre_previewtestItemb "><i className="iii" >{Number(this.props.index+1)<10?"0"+Number(this.props.index+1):Number(this.props.index+1)}</i><i className="ii">/{Number(this.props.examNums)<10?"0"+this.props.examNums:this.props.examNums}</i></b>
              <textarea className="spre_newexamspan" style={stemHei}
              value={this.props.stem} readOnly></textarea>
              <i  className="spre_newi" style={tviewStyle}>已选<span className="xuanxiangstyle" id={this.props.id}>{this.state.exmaxx}</span>选项</i></p>
             ...
             <div className="rightItem spre_newrightItem" style={exStyle}><span className="radiospan_quizz">正确答案:<i id="i">{this.props.answer}</i></span></div>
          </div>
        </div>
    )
  }
