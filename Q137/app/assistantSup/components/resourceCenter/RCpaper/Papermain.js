...
export default class Papermain extends React.Component {
    ...
    PapermainBack() {
        if (sessionStorage.getItem("userJudge") == "T") {
            ...
            hashHistory.push("/assResourceCenter?cI=" + this.state.clickIndex);
        }
    }
    ...
    render() {
        ...
        return (
            <div style={paperStyle}>
                    <div className="papermainTitEMWrap">
                        <div className="papermainTitEM">
                            <h2 className="papermainTithEM">文章详情</h2>
                            <span className="dib paperTitbackEM" onClick={this.PapermainBack.bind(this)}>
                                返回
                                <i className="iconfont icon-back"></i>
                            </span>
                        </div>
                    </div>
                <div className="papermainWrapEmStyle">
                    <div style={Wrapstyle}>
                        ...
                        <div className="Rpaperdiv RpaperdivEM">
