...
export default class TestlistItem extends React.Component {
    ...
    render() {
        ...
        var valueowner = this.props.owner == 0 ? "公有" : this.props.userJudge == "T" ? "私有" : "助教";
        ...
        return (
            <div>
                <div className="spro_thQuBodysqui">
                    ...
                    <div className={this.props.userJudge == "T" ? "spro_laiyquizz" : "spro_laiyquizz_diff"}>{valueowner}</div>
                    ...
                    <div className={this.props.userJudge == "T" ? "spro_caozquizz" : "spro_caozquizz_diff"}>
                        {
                        ...
                        <Link to={this.props.toTalSocre ? {
                            ...
                            query: {id: Base64.encodeURI(this.props.id), zf: "q"}
                        } : null} title="预览试卷"
