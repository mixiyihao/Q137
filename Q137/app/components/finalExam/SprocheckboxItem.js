                ...
                <div className="radioExam">
                    <div className="h-titlItem spre_newexamdiv ">
                        <p className="spre_p final_stem ">
                            <strong style={{ display: this.props.EXLorW != "L" ? "none" : "inline-block" }} className={this.state.exmaxx == this.props.answer ? "iconfont icon-zhengque finalcflag" : "iconfont icon-cuowu finalcflag"}></strong>
                            ...
                            <textarea className="spre_newexamspan"
                                style={stemHei} value={this.props.stem}
                                readOnly></textarea>
                            <i className="spre_newi">已选<span className="xuanxiangstyle" id={this.props.id}>{this.state.exmaxx}</span>选项</i></p>
                        <div className="c1 sproPublishradiocheck" style={styleoptiona}><input autoComplete="off" type="checkbox" name={this.props.id} id={this.props.id + "A"} onChange={this.xx.bind(this)} /><label htmlFor={this.props.id + "A"}><span className="chooseItem1 spre_newchoosespan2">A</span><span className="answerItem1">{this.props.option_a}</span></label></div>
                        <div className="c1 sproPublishradiocheck" style={styleoptionb}><input autoComplete="off" type="checkbox" name={this.props.id} id={this.props.id + "B"} onChange={this.xx.bind(this)} /><label htmlFor={this.props.id + "B"}><span className="chooseItem1 spre_newchoosespan2">B</span><span className="answerItem1">{this.props.option_b}</span></label></div>
                        <div className="c1 sproPublishradiocheck" style={styleoptionc}><input autoComplete="off" type="checkbox" name={this.props.id} id={this.props.id + "C"} onChange={this.xx.bind(this)} /><label htmlFor={this.props.id + "C"}><span className="chooseItem1 spre_newchoosespan2">C</span><span className="answerItem1">{this.props.option_c}</span></label></div>
                        <div className="c1 sproPublishradiocheck" style={styleoptiond}><input autoComplete="off" type="checkbox" name={this.props.id} id={this.props.id + "D"} onChange={this.xx.bind(this)} /><label htmlFor={this.props.id + "D"}><span className="chooseItem1 spre_newchoosespan2">D</span><span className="answerItem1">{this.props.option_d}</span></label></div>
                        <div className="c1 sproPublishradiocheck" style={styleoptione}><input autoComplete="off" type="checkbox" name={this.props.id} id={this.props.id + "E"} onChange={this.xx.bind(this)} /><label htmlFor={this.props.id + "E"}><span className="chooseItem1 spre_newchoosespan2">E</span><span className="answerItem1">{this.props.option_e}</span></label></div>
                        <div className="c1 sproPublishradiocheck" style={styleoptionf}><input autoComplete="off" type="checkbox" name={this.props.id} id={this.props.id + "F"} onChange={this.xx.bind(this)} /><label htmlFor={this.props.id + "F"}><span className="chooseItem1 spre_newchoosespan2">F</span><span className="answerItem1">{this.props.option_f}</span></label></div>

                    </div>
                    <div style={exStyle} className="rightItem spre_newrightItem"><span className="radiospan_final">正确答案:<i id="i">{this.props.answer}</i></span></div>
                </div>
            </div>
